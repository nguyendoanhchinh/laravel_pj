<table class="table table-bordered">
    ...
    @if(isset($users) && is_object($users))
        ...
        <tr>
                ...
                <td class="text-center"> <input type="checkbox" value="{{$user->publish}}" class="js-switch status " data-field="publish" data-modelid="{{$user->id}}" data-model="User" {{ $user->publish==1 ? 'checked' : '' }}  /></td>
